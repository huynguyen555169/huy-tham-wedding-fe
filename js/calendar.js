...
function tzlib_get_ical_block(e, t = !1) {
  const a = tzlib_get_content(e);
  var n;
  return null == a[1] || "" == a[1]
    ? ""
    : ((n = "TZID=" + (e = "" == a[0] ? e : a[0])),
      (e = [
        "BEGIN:VTIMEZONE\r\nTZID:" +
          ...
          e +
          "\r\nLAST-MODIFIED:" +
          a[1].replace(/[^\w_\-:,;=+/<br>]/g, "").replace(/<br>/g, "\r\n") +
          "END:VTIMEZONE",
        n
      ]),
      t ? JSON.stringify(e) : e);
}
function tzlib_get_offset(e, t, a) {
  if (null == (e = tzlib_get_content(e))[1] || "" == e[1]) return "";
  ...
  a = (t = new Date(t + "T" + a + ":00")).getFullYear();
  ...
  var o,
    ...
    l =
      ((t = t.getHours()),
      e[1].replace(/[^\w_\-:,;=+/<br>]/g, "").split("<br>"));
  const s = { 1: {}, 2: {} };
  let c = 0;
  for (let e = 0; e < l.length; e++)
    l["" + e].startsWith("TZOFFSETTO") &&
      (c++, (s["" + c].offset = l["" + e].split(":")[1])),
      l["" + e].startsWith("DTSTART") &&
        (s["" + c].hour = parseInt(l["" + e].substr(17, 2))),
      l["" + e].startsWith("RRULE") &&
        ((o = l["" + e].split(";")),
  ...
  var u = ["SU", "MO", "TU", "WE", "TH", "FR", "SA"],
    m = new Date(a, n, 0).getDate();
  let p = new Date(a, n - 1, 1).getDay();
  const b = { SU: {}, MO: {}, TU: {}, WE: {}, TH: {}, FR: {}, SA: {} };
  for (let e = 1; e <= m; e++) {
    var h = Object.keys(b[u["" + p]]).length + 1;
    (b[u["" + p]]["" + h] = e), 7 == ++p && (p = 0);
  }
  var g;
  return (
    (a =
      "-" == s["" + d].day[0]
        ? ((g = s["" + d].day.substr(2, 2)),
          (e = Object.keys(b["" + g]).length + 1 - parseInt(s["" + d].day[1])),
          b["" + g]["" + e])
        : b["" + (g = s["" + d].day.substr(1, 2))][s["" + d].day[0]]) < r ||
    (r == a && t >= s["" + d].hour)
      ? s["" + d]
      : ((e = 1 == d ? 2 : 1), s["" + e])
  ).offset;
    ...
    0 == tzlibZoneNames.length &&
      (tzlibZoneNames = (function () {
        var e,
          t,
          a = [];
        for ([e, t] of Object.entries(tzlibZonesDB))
          if ("object" != typeof t || Array.isArray(t)) a.push(e);
          else
            for (var [n, o] of Object.entries(t))
              if ("object" != typeof o || Array.isArray(o)) a.push(e + "/" + n);
              else
  ...
  if (null != e.recurrence && "" != e.recurrence)
    if (
      ...
      if (/^RRULE:/i.test(e.recurrence)) {
        var t = e.recurrence.substr(6).split(";");
        const a = new Object();
        t.forEach(function (e) {
          a[e.split("=")[0]] = e.split("=")[1];
        }),
          (e.recurrence_until = a.UNTIL || ""),
          (e.recurrence_count = a.COUNT || ""),
          (e.recurrence_byDay = a.BYDAY || ""),
          (e.recurrence_byMonth = a.BYMONTH || ""),
          (e.recurrence_byMonthDay = a.BYMONTHDAY || ""),
          (e.recurrence_interval = a.INTERVAL || 1),
          (e.recurrence_frequency = a.FREQ || "");
      } else
...
function atcb_decorate_data_options(e) {
  isiOS() &&
    e.options.includes("ical") &&
    !e.options.includes("apple") &&
    e.options.push("apple");
  var t = [];
  e.optionLabels = [];
  for (let o = 0; o < e.options.length; o++) {
    const i = e.options["" + o].split("|");
    var a = i[0].toLowerCase().replace("microsoft", "ms").replace(".", ""),
      n = null != i[1] ? i[1] : "";
    (isiOS() && atcbiOSInvalidOptions.includes(a)) ||
      (null != e.recurrence &&
        "" != e.recurrence &&
        (!atcbValidRecurrOptions.includes(a) ||
          (null != e.recurrence_until &&
            "" != e.recurrence_until &&
            ("apple" == a || "ical" == a)))) ||
      (e.subscribe && atcbInvalidSubscribeOptions.includes(a)) ||
      (t.push(a), e.optionLabels.push(n));
  }
...
function atcb_decorate_data_style(e) {
  if (
    ...
    var t = e.size.split("|");
    for (let e = 0; e < t.length; e++) t["" + e] = parseInt(t["" + e]);
    0 <= t[0] && t[0] < 11 && (e.sizes.l = 10 + t[0]),
      2 < t.length
        ? (0 <= t[1] && t[1] < 11 && (e.sizes.m = 10 + t[1]),
          0 <= t[2] && t[2] < 11 && (e.sizes.s = 10 + t[2]))
        : 2 == t.length &&
          0 <= t[1] &&
          t[1] < 11 &&
          (e.sizes.m = e.sizes.s = 10 + t[1]);
  }
  if (null == e.lightMode || "" == e.lightMode) e.lightMode = "light";
    ...
    switch (e.lightMode) {
      case "system":
        a.matches ? (e.lightMode = "dark") : (e.lightMode = "light");
        break;
      case "bodyScheme":
      case "dark":
        break;
...
function atcb_decorate_data_dates(e) {
  if (null != e.dates && 0 < e.dates.length)
    for (let a = 0; a < e.dates.length; a++) {
      null == e.dates["" + a].timeZone &&
        null != e.timeZone &&
        (e.dates["" + a].timeZone = e.timeZone);
      var t = atcb_date_cleanup(e.dates["" + a]);
      (e.dates["" + a].startTime = t.startTime),
        (e.dates["" + a].endTime = t.endTime),
        (e.dates["" + a].timeZone = t.timeZone),
        (e.dates["" + a].timestamp = t.startTimestamp),
        (e.dates["" + a].startDate = atcb_date_calculation(t.startDate)),
        (e.dates["" + a].endDate = atcb_date_calculation(t.endDate));
    }
  else {
    var a = atcb_date_cleanup(e);
    (e.dates = []),
  ...
  return (
    ...
    (null != e.created && "" != e.created) ||
      (e.created = atcb_format_datetime(a, "clean", !0)),
    (null != e.updated && "" != e.updated) ||
      (e.updated = atcb_format_datetime(a, "clean", !0)),
    e
  );
}
...
function atcb_decorate_data_description(e, t) {
  return (
    null != e.dates["" + t].description && "" != e.dates["" + t].description
      ? ((e.dates["" + t].descriptionHtmlFree = atcb_rewrite_html_elements(
          e.dates["" + t].description,
          !0
        )),
        (e.dates["" + t].description = atcb_rewrite_html_elements(
          e.dates["" + t].description
        )))
...
function atcb_decorate_data_extend(e) {
  for (let t = 0; t < e.dates.length; t++)
    (null != (e = atcb_decorate_data_description(e, t)).dates["" + t].name &&
      "" != e.dates["" + t].name) ||
  ...
  return (
    ...
    1 < e.dates.length && e.dates.sort((e, t) => e.timestamp - t.timestamp),
    e
  );
}
  ...
  return (
    ...
    ["start", "end"].forEach(function (t) {
      ...
      null != e[t + "Date"] &&
        ...
        null != e[t + "Time"] &&
          8 === e[t + "Time"].length &&
          ((a = e[t + "Time"]), (e[t + "Time"] = a.substring(0, a.length - 3))),
        "currentBrowser" == e.timeZone &&
          (e.timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone),
        (n =
          null != e[t + "Time"]
            ? new Date(e[t + "Date"] + " " + e[t + "Time"])
            : new Date(e[t + "Date"])),
        (e[t + "Timestamp"] = n.getTime());
    }),
    e
  );
}
function atcb_date_calculation(e) {
  var t =
    ...
    "-" +
    t.getUTCDate();
  const a = (t = (e = e.replace(/today/gi, t)).split("+"))[0].split("-");
  return (
    (e =
      a[0].length < 4
        ? new Date(Date.UTC(a[2], a[0] - 1, a[1]))
        : new Date(Date.UTC(a[0], a[1] - 1, a[2]))),
    null != t[1] && 0 < t[1] && e.setDate(e.getDate() + parseInt(t[1])),
...
function atcb_validate(e) {
  var t = "Add to Calendar Button generation (" + e.identifier + ")";
  return !!(
    atcb_validate_icsFile(e, t) &&
    atcb_validate_subscribe(e, t) &&
    atcb_validate_created(e, t) &&
    atcb_validate_updated(e, t) &&
    atcb_validate_options(e, t) &&
    atcb_validate_date_blocks(e, t) &&
    atcb_validate_rrule(e, t)
  );
}
function atcb_validate_icsFile(e, t, a = "", n = "") {
  return !(
    "" !=
      (a =
        "" != a && null != e.dates["" + a].icsFile
          ? e.dates["" + a].icsFile
          : "" == a && null != e.icsFile
          ? e.icsFile
          : "") &&
    ...
    (console.error(t + " failed: explicit ics file path not valid" + n), 1)
  );
}
function atcb_validate_subscribe(e, t) {
  return (
    1 != e.subscribe ||
...
function atcb_validate_created(e, t) {
  return (
...
function atcb_validate_updated(e, t) {
  return (
...
function atcb_validate_options(e, t) {
  return !!e.options.every(function (e) {
    return (
      !!atcbOptions.includes(e) ||
      (console.error(t + " failed: invalid option [" + e + "]"), !1)
    );
  });
}
function atcb_validate_date_blocks(e, t) {
  for (let n = 0; n < e.dates.length; n++) {
    var a =
      1 == e.dates.length
        ? ""
        : " [dates array object #" + (n + 1) + "/" + e.dates.length + "] ";
    if (!atcb_validate_icsFile(e, t, n, a)) return !1;
    if (!atcb_validate_status(e, t, n, a)) return !1;
    if (!atcb_validate_availability(e, t, n, a)) return !1;
    if (!atcb_validate_organizer(e, t, n, a)) return !1;
    if (!atcb_validate_uid(e, t, n, a)) return !1;
    if (!atcb_validate_sequence(e, t, n, a)) return !1;
    if (!atcb_validate_timezone(e, t, n, a)) return !1;
    if (!atcb_validate_datetime(e, t, n, a)) return !1;
  }
  return !0;
}
function atcb_validate_status(e, t, a, n) {
  return (
    "TENTATIVE" == e.dates["" + a].status ||
    "CONFIRMED" == e.dates["" + a].status ||
...
function atcb_validate_availability(e, t, a, n) {
  return (
    null == e.dates["" + a].availability ||
    "" == e.dates["" + a].availability ||
    "free" == e.dates["" + a].availability ||
    "busy" == e.dates["" + a].availability ||
    (console.error(
      t + ' failed: event availability needs to be "free" or "busy"' + n
    ),
    !1)
  );
}
function atcb_validate_organizer(e, t, a, n) {
  return (
    !(
      null != e.dates["" + a].organizer &&
      "" != e.dates["" + a].organizer &&
      (2 != (e = e.dates["" + a].organizer.split("|")).length ||
        50 < e[0].length ||
        80 < e[1].length ||
        !atcb_validEmail(e[1]))
    ) ||
...
function atcb_validate_uid(e, t, a, n) {
  return (
    /^(\w|-){1,254}$/.test(e.dates["" + a].uid) ||
      ...
      (e.dates["" + a].uid = atcb_generate_uuid())),
...
function atcb_validate_sequence(e, t, a, n) {
  return (
    /^\d+$/.test(e.dates["" + a].sequence) ||
      (console.log(
        t + ": sequence needs to be a number. Used the default 0 instead" + n
      ),
      (e.dates["" + a].sequence = 0)),
    !0
  );
}
function atcb_validate_timezone(e, t, a, n) {
  return (
    !(
      null != e.dates["" + a].timeZone &&
      "" != e.dates["" + a].timeZone &&
      !tzlib_get_timezones().includes(e.dates["" + a].timeZone)
    ) || (console.error(t + " failed: invalid time zone given" + n), !1)
  );
}
function atcb_validate_datetime(e, t, a, n) {
  var o = ["startDate", "endDate"];
  const i = o;
  return !(
    !o.every(function (o) {
      var r;
      return 10 !== e.dates["" + a]["" + o].length
        ? (console.error(t + " failed: date misspelled [-> YYYY-MM-DD]" + n),
          !1)
        : (r = e.dates["" + a]["" + o].split("-")).length < 3 || 3 < r.length
        ? (console.error(
            t +
          ...
          !1)
        : ((i["" + o] = new Date(r[0], r[1] - 1, r[2])), !0);
    }) ||
    !["startTime", "endTime"].every(function (o) {
      if (null != e.dates["" + a]["" + o]) {
        if (5 !== e.dates["" + a]["" + o].length)
          return (
            console.error(t + " failed: time misspelled [-> HH:MM]" + n), !1
          );
        var r = e.dates["" + a]["" + o].split(":");
        if (r.length < 2 || 2 < r.length)
          return (
            console.error(
              t +
        ...
        "startTime" == o &&
          (i.startDate = new Date(
            i.startDate.getTime() + 36e5 * r[0] + 6e4 * r[1]
          )),
          "endTime" == o &&
            (i.endDate = new Date(
              i.endDate.getTime() + 36e5 * r[0] + 6e4 * r[1]
            ));
      }
      return !0;
    }) ||
    ((null != e.dates["" + a].startTime && null == e.dates["" + a].endTime) ||
    (null == e.dates["" + a].startTime && null != e.dates["" + a].endTime)
      ? (console.error(
          t +
      ...
      : i.endDate < i.startDate &&
        (console.error(t + " failed: end date before start date" + n), 1))
  );
}
function atcb_validate_rrule(e, t) {
  return null != e.recurrence && "" != e.recurrence && 1 < e.dates.length
    ? (console.error(t + " failed: RRULE and multi-date set at the same time"),
      !1)
    : null == e.recurrence ||
      "" == e.recurrence ||
            ...
            ? null == e.recurrence_byMonthDay ||
              ...
              ? null == e.recurrence_byDay ||
                ...
                ? !(
                    ...
                    (console.error(
                      t + " failed: recurrence data (weekstart) misspelled"
                    ),
                    1)
                  )
                : (console.error(
                    t + " failed: recurrence data (byDay) misspelled"
                  ),
                  !1)
              : (console.error(
                  t + " failed: recurrence data (byMonthDay) misspelled"
                ),
                !1)
            : (console.error(
                t + " failed: recurrence data (byMonth) misspelled"
              ),
              !1)
          : (console.error(
              t + " failed: recurrence data (interval) misspelled"
            ),
            !1)
        : (console.error(t + " failed: recurrence data (until) misspelled"), !1)
      : (console.error(t + " failed: recurrence data (interval) misspelled"),
        !1)
    : (console.error(t + " failed: RRULE data misspelled"), !1);
}
...
function atcb_open(e, t, a = !1, n = !1) {
  if (
    ...
    r.classList.add("atcb-list-wrapper"),
      0 == e.textLabelList && r.classList.add("atcb-no-text"),
      t
        ? (t.classList.add("atcb-active"),
          "modal" === e.listStyle
            ...
            : (r.appendChild(o),
              ...
              "overlay" === e.listStyle && r.classList.add("atcb-dropoverlay"),
              e.mindScrolling && r.classList.add("atcb-mind-scrolling")),
    ...
    "modal" === e.listStyle
      ...
      : (((i = document.createElement("div")).id = "atcb-pos-wrapper"),
        ...
        i.appendChild(r),
        r.appendChild(o),
        "" != e.buttonStyle && r.classList.add("atcb-style-" + e.buttonStyle),
        ...
        setTimeout(function () {
          (r.style.display = "block"),
            "dropdown-static" === e.listStyle
              ? atcb_position_list(t, r, !0)
              : atcb_position_list(t, r);
        }, 5)),
      atcb_set_fullsize(n),
...
function atcb_close(e = !1) {
  ...
  if (1 < t.length) {
    ...
    let a = t;
    (a = 0 < (t = t.getElementsByTagName("button")).length ? t[0] : a).focus(),
      e || a.blur();
  } else
    (t = document.querySelector(".atcb-active, .atcb-active-modal")) &&
      (t.focus({ preventScroll: !0 }), e || t.blur()),
...
function atcb_generate_label(e, t, a, n = !1, o = "", i = !1) {
  switch (a) {
    case "trigger":
    default:
      (t.id = e.identifier),
        "click" === e.trigger
          ? t.addEventListener("click", (a) => {
              a.preventDefault(), atcb_toggle("auto", e, t, !1, !0);
            })
          : (t.addEventListener("touchend", (a) => {
            ...
            t.addEventListener(
              ...
              atcb_debounce_leading((a) => {
                a.preventDefault(), atcb_toggle("open", e, t, !1, !0);
              })
            )),
        t.addEventListener("keyup", function (a) {
          "Enter" == a.key &&
            (a.preventDefault(), atcb_toggle("auto", e, t, !0, !0));
        });
      break;
    case "apple":
    case "google":
    ...
    case "yahoo":
      (t.id = e.identifier + "-" + a),
        t.addEventListener(
          "click",
          atcb_debounce(() => {
            i ? t.blur() : atcb_toggle("close"), atcb_generate_links(a, e);
          })
        ),
        t.addEventListener("keyup", function (n) {
          "Enter" == n.key &&
            ...
            atcb_generate_links(a, e, "all", !0));
        });
      break;
    case "close":
      (t.id = e.identifier + "-close"),
        t.addEventListener(
          "click",
          atcb_debounce(() => {
            atcb_toggle("close");
        ...
        t.addEventListener("keyup", function (t) {
          "Enter" == t.key &&
            (t.preventDefault(), atcb_toggle("close", e, "all", !0));
        });
  }
  i && (t.id = e.identifier), atcb_generate_label_content(e, t, a, n, o, i);
}
function atcb_generate_label_content(e, t, a, n, o, i) {
  var r = atcb_translate_hook("Add to Calendar", e);
  switch ((i && "" == o && (o = r), a)) {
    case "trigger":
    default:
      o = o || r;
  ...
  ("date" == e.buttonStyle && ("trigger" == a || i)) ||
    (n &&
      ((i = document.createElement("span")).classList.add("atcb-icon"),
      (i.innerHTML = atcbIcon["" + a]),
      t.appendChild(i)),
    (("trigger" == a && 1 == e.textLabelButton) ||
      ("trigger" != a && 1 == e.textLabelList)) &&
      ((n = document.createElement("span")).classList.add("atcb-text"),
      (n.textContent = o),
      t.appendChild(n)));
}
function atcb_generate_button(e, t) {
  (e.textContent = ""),
    t.richData &&
      t.name &&
      t.dates[0].location &&
      t.dates[0].startDate &&
      atcb_generate_rich_data(t, e);
  var a = document.createElement("div"),
    n =
      (a.classList.add("atcb-button-wrapper"),
      a.classList.add("atcb-" + t.lightMode),
      t.rtl && a.classList.add("atcb-rtl"),
      e.appendChild(a),
      atcb_set_sizes(a, t.sizes),
      document.createElement("button"));
  n.classList.add("atcb-button"),
    0 == t.textLabelButton && n.classList.add("atcb-no-text"),
    "click" === t.trigger && n.classList.add("atcb-click"),
    "overlay" === t.listStyle && n.classList.add("atcb-dropoverlay"),
    (n.type = "button"),
    a.appendChild(n),
    "date" == t.buttonStyle && atcb_generate_date_button(t, n),
    1 === t.options.length
      ? (n.classList.add("atcb-single"),
        atcb_generate_label(t, n, t.options[0], t.iconButton, t.label, !0))
      : (atcb_generate_label(t, n, "trigger", t.iconButton, t.label),
        (a = document.createElement("div")).classList.add(
          "atcb-dropdown-anchor"
        ),
        n.appendChild(a)),
    t.checkmark &&
      ((a = document.createElement("div")).classList.add("atcb-checkmark"),
      (a.innerHTML = atcbIcon.checkmark),
      n.appendChild(a)),
...
function atcb_generate_rich_data(e, t) {
  var a,
    ...
    i =
      (1 < e.dates.length &&
        ((a = []).push('"@context":"https://schema.org"'),
        a.push('"@type":"EventSeries"'),
        a.push('"@id":"' + e.name.replace(/\s/g, "") + '"'),
        a.push('"name":"' + e.name + '",'),
        o.push("{\r\n" + a.join(",\r\n") + "\r\n")),
      []);
  for (let t = 0; t < e.dates.length; t++) {
    var r = [],
      l =
        ...
        atcb_generate_time(e.dates["" + t], "delimiters", "general", !0)),
      s =
        (r.push('"startDate":"' + l.start + '"'),
        null != l.duration && r.push('"duration":"' + l.duration + '"'),
        r.push(
        ...
        null != e.recurrence && "" != e.recurrence
...
function atcb_generate_rich_data_recurrence(e, t) {
  var a = [],
    n =
  ...
  return (
    ...
    null != e.recurrence_byDay &&
      ...
      ((n = (function () {
        ...
        var t = e.recurrence_byDay.split(","),
          a = {
          ...
          n = [];
        for (let e = 0; e < t.length; e++) n.push('"' + a[t["" + e]] + '"');
        return "[" + n.join(",") + "]";
      })()),
      a.push('"byDay":' + n)),
    null != e.recurrence_byMonth &&
...
function atcb_generate_dropdown_list(e) {
  ...
  t.classList.add("atcb-list"),
    ...
    e.rtl && t.classList.add("atcb-rtl");
  let a = 0;
  var n;
  return (
    e.options.forEach(function (n) {
      var o = document.createElement("div");
      o.classList.add("atcb-list-item"),
        (o.tabIndex = 0),
        a++,
        (o.dataset.optionNumber = a),
        t.appendChild(o),
        atcb_generate_label(e, o, n, e.iconList, e.optionLabels[a - 1]);
    }),
    "modal" === e.listStyle &&
      ...
      (n.tabIndex = 0),
      t.appendChild(n),
      atcb_generate_label(e, n, "close", e.iconList)),
    t
  );
}
function atcb_generate_bg_overlay(e = "dropdown", t = "", a = "light", n = !0) {
  var o = document.createElement("div");
  (o.id = "atcb-bgoverlay"),
    "modal" !== e && n && o.classList.add("atcb-animate-bg"),
    n || o.classList.add("atcb-no-bg"),
    o.classList.add("atcb-" + a),
    (o.tabIndex = 0),
    o.addEventListener(
      "click",
      atcb_debounce((e) => {
...
function atcb_create_modal(e, t = "", a, n = "", o = [], i = [], r = !1) {
  var l,
    s =
      document.getElementById("atcb-bgoverlay") ||
      atcb_generate_bg_overlay("modal", "click", e.lightMode, e.background),
    c =
      (s.classList.add("atcb-no-animation"),
  ...
  if (
    ((t =
      ((l =
        (null !=
          ...
          l.classList.add("atcb-active-modal"),
        document.createElement("div"))).classList.add("atcb-modal-box"),
      l.classList.add("atcb-" + e.lightMode),
      e.rtl && l.classList.add("atcb-rtl"),
      c.appendChild(l),
      atcb_set_sizes(l, e.sizes),
      atcb_set_fullsize(s),
      "" != t &&
        1 == e.iconModal &&
        ...
        l.appendChild(s)),
      document.createElement("div"))).classList.add("atcb-modal-headline"),
    (t.textContent = a),
    l.appendChild(t),
    "" != n &&
      ((s = document.createElement("div")).classList.add("atcb-modal-content"),
      (s.innerHTML = n),
      l.appendChild(s)),
    1 < i.length)
  ) {
    ...
    u.classList.add("atcb-modal-content"), l.appendChild(u);
    for (let t = 1; t < i.length; t++) {
      var m = document.createElement("button");
      switch (
        ((m.type = "button"),
        (m.id = e.identifier + "-" + i[0] + "-" + t),
        0 < atcbStates["" + e.identifier]["" + i[0]][t - 1] &&
          m.classList.add("atcb-saved"),
        m.classList.add("atcb-subevent-btn"),
        u.appendChild(m),
        atcb_generate_date_button(e, m, t),
        1 == t && r && m.focus(),
        i[0])
      ) {
        case "apple":
        ...
        case "yahoo":
          m.addEventListener(
            "click",
            atcb_debounce(() => {
              atcb_generate_links(i[0], e, i["" + t], r, !0);
            })
          );
      }
    }
  ...
  0 == o.length &&
    o.push({ type: "close", label: atcb_translate_hook("Close", e) });
  ...
  p.classList.add("atcb-modal-buttons"),
    ...
    o.forEach((t, a) => {
      ...
      switch (
        ...
        n.classList.add("atcb-modal-btn"),
        t.primary && n.classList.add("atcb-modal-btn-primary"),
        (null != t.label && "" != t.label) ||
          (t.label = atcb_translate_hook("Click me", e)),
        (n.textContent = t.label),
        p.appendChild(n),
        0 == a && i.length < 2 && r && n.focus(),
        t.type)
      ) {
        default:
        case "close":
        ...
        case "yahoo2nd":
          n.addEventListener(
            "click",
            atcb_debounce(() => {
              atcb_close(), atcb_subscribe_yahoo_modal_switch(e);
            })
          ),
            n.addEventListener("keyup", function (t) {
              "Enter" == t.key &&
                (atcb_toggle("close", "", "", !0),
                atcb_subscribe_yahoo_modal_switch(e, r));
            });
          break;
        case "none":
      }
    ...
    1 < d &&
      (document.querySelectorAll(
        '.atcb-modal[data-modal-nr="' + (d - 1) + '"]'
      )[0].style.display = "none"),
    atcb_manage_body_scroll(c);
}
function atcb_subscribe_yahoo_modal_switch(e, t) {
  atcb_set_fully_successful(e.identifier),
    atcb_generate_links("yahoo2nd", e, "all", t);
}
function atcb_generate_date_button(e, t, a = "all") {
  "all" != a ? (a = parseInt(a) - 1) : 1 == e.dates.length && (a = 0);
  var n,
    o = (function () {
      let t,
        n,
        ...
        s =
          ((i =
            "all" == a
              ? ((r = atcb_generate_time(e.dates[0])),
                (l = atcb_generate_time(e.dates[e.dates.length - 1])),
                (o = e.dates[0].timeZone),
                e.dates[e.dates.length - 1].timeZone)
              : ((r = atcb_generate_time(e.dates["" + a])),
                (l = r),
                (o = e.dates["" + a].timeZone))),
          (t = new Date(r.start)),
          (n = new Date(l.end)),
          (null != o && "" != o && !r.allday) || (o = "UTC"),
          (null != i && "" != i && !l.allday) || (i = "UTC"),
          ""),
        c = "",
        d = "";
      r.allday ||
        Intl.DateTimeFormat().resolvedOptions().timeZone == o ||
        o == i ||
        (c = " (" + o + ")"),
        ((l.allday || Intl.DateTimeFormat().resolvedOptions().timeZone == i) &&
          o == i) ||
          (d = " (" + i + ")");
      var u = get_format_options(o),
        m = get_format_options(i);
      return (
        t.getFullYear() === n.getFullYear() &&
        t.getMonth() === n.getMonth() &&
        t.getDate() === n.getDate()
          ? (s = r.allday
              ? t.toLocaleDateString(e.language, u.DateShort)
              : t.toLocaleString(e.language, u.DateTimeShort) +
                c +
                " - " +
                n.toLocaleTimeString(e.language, m.Time) +
                d)
          : ((s = r.allday
              ? t.toLocaleDateString(e.language, u.DateShort)
              : t.toLocaleString(e.language, u.DateTimeShort)),
            (s += c + " - "),
            l.allday
              ? (s += n.toLocaleDateString(e.language, m.DateLong))
              : (s += n.toLocaleString(e.language, m.DateTimeLong)),
            (s += d)),
        s
      );
    })(),
    i =
      "all" != a && "CANCELLED" == e.dates["" + a].status
        ? atcb_translate_hook("Cancelled Date", e) +
          "<br>" +
          atcb_translate_hook("Delete from Calendar", e)
        : "+ " + atcb_translate_hook("Add to Calendar", e),
    r =
      "all" != a && "CANCELLED" == e.dates["" + a].status
        ? atcb_translate_hook("Cancelled Date", e)
        : "",
    l = ("all" == a && (a = 0), new Date(e.dates["" + a].startDate)),
    s =
      null != e.dates["" + a].timeZone && "" != e.dates["" + a].timeZone
        ? e.dates["" + a].timeZone
        : "UTC",
    c =
      ((d =
        ((c =
          ...
          t.appendChild(n),
          document.createElement("div"))).classList.add("atcb-date-btn-day"),
        n.appendChild(c),
        document.createElement("div"))).classList.add("atcb-date-btn-month"),
      (c.textContent = l.toLocaleString(e.language, {
        day: "numeric",
        timeZone: s
      })),
      (d.textContent = l.toLocaleString(e.language, {
        month: "short",
        timeZone: s
      })),
      n.appendChild(d),
    ...
    d =
      ((r =
        ((s =
          ((l =
            (c.classList.add("atcb-date-btn-right"),
            t.appendChild(c),
        ...
        (s.textContent = e.dates["" + a].name),
        l.appendChild(s),
        ((null != e.location && "" != e.location) || "" != r) &&
          ((n = document.createElement("div")).classList.add(
          ...
          "" != r
            ? ((n.textContent = r),
              ...
              (n.style.color = "#9c1a23"))
            : (n.classList.add("atcb-date-btn-content-location"),
              (d = document.createElement("span")).classList.add(
                "atcb-date-btn-content-icon"
              ),
              (d.innerHTML = atcbIcon.location),
              n.appendChild(d),
              ((s = document.createElement("span")).textContent = e.location),
              n.appendChild(s))),
        document.createElement("div"))).classList.add("atcb-date-btn-content"),
      l.appendChild(r),
      document.createElement("span"));
  (l =
    (((n =
      (d.classList.add("atcb-date-btn-content-icon"),
      (d.innerHTML = atcbIcon.ical),
      r.appendChild(d),
      document.createElement("span"))).textContent = o),
    r.appendChild(n),
    null != e.recurrence &&
      "" != e.recurrence &&
      ...
      r.appendChild(s),
      (s.innerHTML = "&#x27F3;")),
    document.createElement("div"))).classList.add("atcb-date-btn-hover"),
    (l.innerHTML = i),
    c.appendChild(l),
    e.checkmark &&
      ((d = document.createElement("div")).classList.add("atcb-checkmark"),
      (d.innerHTML = atcbIcon.checkmark),
      t.appendChild(d));
}
...
function atcb_generate_links(e, t, a = "all", n = !1, o = !1) {
  if (
    ("all" != a ? (a = parseInt(a) - 1) : 1 == t.dates.length && (a = 0),
    t.subscribe)
  )
    atcb_generate_subscribe_links(e, t, n);
  else if (
    (!isMobile() ||
    ...
    if ("CANCELLED" == t.dates["" + a].status && "apple" != e && "ical" != e)
      atcb_create_modal(
        t,
        "warning",
        atcb_translate_hook("Cancelled Date", t),
        atcb_translate_hook("Delete from Calendar", t),
        [],
        [],
        n
      );
      ...
      switch (e) {
        case "apple":
        case "ical":
          atcb_generate_ical(t, a, n);
          break;
        case "google":
          atcb_generate_google(t.dates["" + a]);
          break;
        case "msteams":
          atcb_generate_msteams(t.dates["" + a]);
          break;
        case "ms365":
          atcb_generate_microsoft(t.dates["" + a]);
          break;
        case "outlookcom":
          atcb_generate_microsoft(t.dates["" + a], "outlook");
          break;
        case "yahoo":
          atcb_generate_yahoo(t.dates["" + a]);
      }
    var i;
    0 ==
      (i =
        ...
        atcbStates["" + t.identifier]["" + e]["" + a]++,
        atcbStates["" + t.identifier]["" + e].filter(function (e) {
          return e < 1;
        }))).length && atcb_set_fully_successful(t.identifier, o);
  } else atcb_generate_multidate_links(e, t, n, o);
}
function atcb_generate_multidate_links(e, t, a, n) {
  if (
    ("ical" != e && "apple" != e) ||
    ...
    atcb_generate_ical(t, "all", a);
    for (let a = 0; a < atcbStates["" + t.identifier]["" + e].length; a++)
      atcbStates["" + t.identifier]["" + e]["" + a]++;
    atcb_set_fully_successful(t.identifier, n);
  }
}
function atcb_generate_subscribe_links(e, t, a) {
  var n = t.icsFile.replace("https://", "webcal://");
  switch (e) {
    case "apple":
    case "ical":
    ...
    case "google":
      ...
      break;
    case "ms365":
      atcb_subscribe_microsoft(n, t.name);
      break;
    case "outlookcom":
      atcb_subscribe_microsoft(n, t.name, "outlook");
      break;
    case "yahoo":
      return (
        atcb_copy_to_clipboard(t.icsFile),
        void atcb_create_modal(
          t,
          "yahoo",
          atcb_translate_hook("modal.subscribe.yahoo.h", t),
          atcb_translate_hook("modal.clipboard.text", t) +
            "<br>" +
            atcb_translate_hook("modal.subscribe.yahoo.text", t),
          [
            {
              label: atcb_translate_hook("Open Yahoo Calendar", t),
              primary: !0,
              type: "yahoo2nd",
              href: "https://www.yahoo.com/calendar"
            },
            { label: atcb_translate_hook("Cancel", t) }
          ],
          [],
          a
        )
  ...
  atcb_set_fully_successful(t.identifier);
}
function atcb_set_fully_successful(e, t) {
  (e = document.getElementById(e)) && e.classList.add("atcb-saved"),
    atcb_saved_hook(),
    t &&
...
function atcb_subscribe_microsoft(e, t, a = "365") {
  var n = [];
  a =
    "outlook" == a
  ...
  n.push("url=" + encodeURIComponent(e)),
    n.push("name=" + encodeURIComponent(t)),
    atcb_open_cal_url(a + n.join("&"));
}
function atcb_generate_google(e) {
  ...
  t.push(
    ...
    null != e.name &&
      "" != e.name &&
      t.push("text=" + encodeURIComponent(e.name)),
    (a = []);
  null != e.description && "" != e.description && a.push(e.description),
    null != e.location &&
      "" != e.location &&
      (t.push("location=" + encodeURIComponent(e.location)),
      isiOS() &&
        (0 < a.length && a.push("<br><br>"),
        a.push("&#128205;: " + e.location))),
    0 < a.length && t.push("details=" + encodeURIComponent(a.join())),
    null != e.recurrence &&
      "" != e.recurrence &&
      t.push("recur=" + encodeURIComponent(e.recurrence)),
    null != e.availability &&
      "" != e.availability &&
      ((a =
        "free" == e.availability
...
function atcb_generate_yahoo(e) {
  ...
  t.push(
    ...
    a.allday && t.push("dur=allday"),
    null != e.name &&
      "" != e.name &&
      t.push("title=" + encodeURIComponent(e.name)),
    null != e.location &&
      "" != e.location &&
      t.push("in_loc=" + encodeURIComponent(e.location)),
    null != e.descriptionHtmlFree &&
      "" != e.descriptionHtmlFree &&
      t.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)),
    atcb_open_cal_url(t.join("&"));
}
function atcb_generate_microsoft(e, t = "365") {
  ...
  (t =
    ...
    a.push("startdt=" + encodeURIComponent(t.start)),
    a.push("enddt=" + encodeURIComponent(t.end)),
    t.allday && a.push("allday=true"),
    null != e.name &&
      "" != e.name &&
...
function atcb_generate_msteams(e) {
  ...
  t.push("startTime=" + encodeURIComponent(a.start)),
    t.push("endTime=" + encodeURIComponent(a.end)),
    null != e.name &&
      "" != e.name &&
  ...
  null != e.location &&
    ...
    null != e.descriptionHtmlFree &&
      "" != e.descriptionHtmlFree &&
      t.push("content=" + n + encodeURIComponent(e.descriptionHtmlFree)),
    t.push("uid=" + encodeURIComponent(e.uid)),
    atcb_open_cal_url(
      "https://teams.microsoft.com/l/meeting/new?" + t.join("&")
    );
}
function atcb_open_cal_url(e, t = "") {
  "" == t && (t = atcbDefaultTarget),
    atcb_secure_url(e) && window.open(e, t).focus();
}
function atcb_generate_ical(e, t = "all", a = !1) {
  "all" != t && (t = parseInt(t));
  var n = atcb_determine_ical_filename(e, t);
  const o =
    "all" != t &&
    null != e.dates["" + t].icsFile &&
    "" != e.dates["" + t].icsFile
      ? e.dates["" + t].icsFile
      : null != e.icsFile && "" != e.icsFile
      ? e.icsFile
  ...
  if ("" == o || (isiOS() && isWebView())) {
    ...
    const c = ["BEGIN:VCALENDAR", "VERSION:2.0"],
      d =
        (c.push(
          "PRODID:-// https://add-to-calendar-pro.com // button v1.18.7 //EN"
        ),
        ...
        "all" == t
          ...
          : null != e.dates["" + t].organizer && "" != e.dates["" + t].organizer
          ? c.push("METHOD:REQUEST")
          : c.push("METHOD:PUBLISH"),
        []);
    var r = "all" != t ? t : 0,
      l = "all" != t ? t : e.dates.length - 1;
    for (let t = r; t <= l; t++) {
      const a = atcb_generate_time(e.dates["" + t], "clean", "ical");
      s = void 0;
      var s = a.allday
        ? ";VALUE=DATE"
        : null != e.dates["" + t].timeZone && "" != e.dates["" + t].timeZone
        ? ((s = tzlib_get_ical_block(e.dates["" + t].timeZone)),
          d.includes(e.dates["" + t].timeZone) || c.push(s[0]),
          d.push(e.dates["" + t].timeZone),
          ";" + s[1])
        : void 0;
      c.push("BEGIN:VEVENT"),
        c.push("UID:" + e.dates["" + t].uid),
        c.push("DTSTAMP:" + atcb_format_datetime(i, "clean", !0)),
        c.push("DTSTART" + s + ":" + a.start),
        c.push("DTEND" + s + ":" + a.end),
        c.push("SUMMARY:" + e.dates["" + t].name.replace(/.{65}/g, "$&\r\n ")),
        null != e.dates["" + t].descriptionHtmlFree &&
          "" != e.dates["" + t].descriptionHtmlFree &&
          c.push(
            "DESCRIPTION:" +
              e.dates["" + t].descriptionHtmlFree
        ...
        null != e.dates["" + t].location &&
          "" != e.dates["" + t].location &&
          c.push("LOCATION:" + e.dates["" + t].location),
        null != e.dates["" + t].organizer &&
          "" != e.dates["" + t].organizer &&
          ((s = e.dates["" + t].organizer.split("|")),
          c.push("ORGANIZER;CN=" + s[0] + ":MAILTO:" + s[1])),
        null != e.recurrence && "" != e.recurrence && c.push(e.recurrence),
        null != e.dates["" + t].availability &&
          "" != e.dates["" + t].availability &&
          ((s =
            "free" == e.dates["" + t].availability ? "TRANSPARENT" : "OPAQUE"),
          c.push("TRANSP:" + s)),
        c.push("SEQUENCE:" + e.dates["" + t].sequence),
        c.push("STATUS:" + e.dates["" + t].status),
        c.push("CREATED:" + e.created),
        c.push("LAST-MODIFIED:" + e.updated),
        c.push("END:VEVENT");
    }
    c.push("END:VCALENDAR"),
      ...
      (isWebView() && (isiOS() || (isAndroid() && isProblematicWebView())))
        ? atcb_ical_copy_note(t, e, a)
        : atcb_save_file(t, n);
  } else atcb_save_file(o, n);
}
function atcb_determine_ical_filename(e, t) {
  return (
    (t = "all" != t && 0 != t ? "-" + parseInt(t) + 1 : ""),
    null != e.iCalFileName && "" != e.iCalFileName
      ? e.iCalFileName + t
      : null != e.icsFile &&
        "" != e.icsFile &&
        "" != (e = e.icsFile.split("/").pop().split(".")[0])
      ? e + t
      : "event-to-save-in-my-calendar" + t
  );
}
function atcb_ical_copy_note(e, t, a) {
  atcb_copy_to_clipboard(e),
    isiOS() && isChrome()
      ? atcb_create_modal(
          t,
          "warning",
          atcb_translate_hook("modal.crios.ical.h", t),
          atcb_translate_hook("modal.crios.ical.text", t) +
            "<br>" +
            atcb_translate_hook("modal.clipboard.text", t) +
            "<br>" +
            atcb_translate_hook("modal.crios.ical.steps", t),
          [],
          [],
          a
        )
      : atcb_create_modal(
          t,
          "warning",
          atcb_translate_hook("modal.webview.ical.h", t),
          atcb_translate_hook("modal.webview.ical.text", t) +
            "<br>" +
            atcb_translate_hook("modal.clipboard.text", t) +
            "<br>" +
            atcb_translate_hook("modal.webview.ical.steps", t),
          [],
          [],
          a
        );
...
function atcb_save_file(e, t) {
  try {
    var a = document.createElementNS("http://www.w3.org/1999/xhtml", "a"),
      n =
        ((a.rel = "noopener"),
        (a.href = e),
        isMobile() ? (a.target = "_self") : (a.target = "_blank"),
        (a.download = t + ".ics"),
...
function atcb_generate_time(e, t = "delimiters", a = "general", n = !1) {
  if (
    null == e.startTime ||
    "" == e.startTime ||
    null == e.endTime ||
    ...
    return (
      ...
      {
        start: atcb_format_datetime(o, t, !1),
        end: atcb_format_datetime(i, t, !1),
        allday: !0
      }
    );
  {
    ...
    const s = Math.floor(r / 1e3 / 60 / 60),
      c = Math.floor(((r - 60 * s * 60 * 1e3) / 1e3 / 60) % 60);
    if (
      ((r =
        s < 10
          ? "0" + s + ":" + ("0" + c).slice(-2)
          : s + ":" + ("0" + c).slice(-2)),
      (null == e.timeZone || (null != e.timeZone && "" == e.timeZone)) && n)
    )
      return {
    ...
    if (null != e.timeZone && "" != e.timeZone) {
      ...
      if (
        ((a = tzlib_get_offset(e.timeZone, e.startDate, e.startTime)),
        (e = tzlib_get_offset(e.timeZone, e.endDate, e.endTime)),
        n)
      )
        return (
          (n = a.slice(0, 3) + ":" + a.slice(3)),
          (l = e.slice(0, 3) + ":" + e.slice(3)),
          {
            start: o.toISOString().replace(".000Z", n),
            end: i.toISOString().replace(".000Z", l),
            duration: r,
            allday: !1
          }
        );
      n =
        -1 *
        parseInt(a[0] + 1) *
        (60 * (60 * parseInt(a.substr(1, 2)) + parseInt(a.substr(3, 2))) * 1e3);
      var l =
        -1 *
        parseInt(e[0] + 1) *
        (60 * (60 * parseInt(e.substr(1, 2)) + parseInt(e.substr(3, 2))) * 1e3);
      o.setTime(o.getTime() + n), i.setTime(i.getTime() + l);
    }
    return {
      start: atcb_format_datetime(o, t),
      end: atcb_format_datetime(i, t),
      duration: r,
      allday: !1
    };
  }
}
function atcb_format_datetime(e, t = "delimiters", a = !0, n = !1) {
  return (
    (a = a
      ? "clean" == t
        ? /(-|:|(\.\d{3}))/g
...
function atcb_secure_content(e, t = !0) {
  return (
    (e = (t ? JSON.stringify(e) : e).replace(/(<(?!br)([^>]+)>)/gi, "")),
    t ? JSON.parse(e) : e
  );
}
...
function atcb_validEmail(e, t = !1) {
  return (
    !!/^.{0,70}@.{1,30}\.[\w.]{2,9}$/.test(e) &&
    (t && console.log("Testing for MX records not yet available"), !0)
  );
}
...
function atcb_position_list(e, t, a = !1, n = !1) {
  ...
  (s =
    (null !== (s = document.getElementById("atcb-pos-wrapper")) &&
      (s.style.height = d + "px"),
    !0 !== o || t.classList.contains("atcb-dropoverlay")
      ? ((t.style.minWidth = c.width + 20 + "px"),
        (l = t.getBoundingClientRect()),
        (t.style.top =
          window.scrollY + c.top + c.height / 2 - l.height / 2 + "px"),
        (t.style.left = c.left - (l.width - c.width) / 2 + "px"))
      : ((t.classList.contains("atcb-dropup") && n) ||
        (!a &&
          !n &&
          r.top + l.height > d - 20 &&
          20 < 2 * c.top + c.height - r.top - l.height)
          ? (i.classList.add("atcb-dropup"),
            t.classList.add("atcb-dropup"),
            (t.style.bottom =
              2 * d -
              (d + (c.top + (c.top + c.height - r.top))) -
              window.scrollY +
              "px"))
        ...
        t.classList.contains("atcb-style-bubble") ||
        t.classList.contains("atcb-style-text")
          ? (t.style.minWidth = r.width + "px")
          : (t.style.width = r.width + "px"),
        (l = t.getBoundingClientRect()),
        (t.style.left = r.left - (l.width - r.width) / 2 + "px")),
    document.getElementById("add-to-calendar-button-reference"))) &&
    (i.classList.contains("atcb-dropup")
      ? ((s.style.top = window.scrollY + c.top + c.height + "px"),
        (s.style.left = c.left + (c.width - 150) / 2 + "px"))
      : ((l = t.getBoundingClientRect()),
        i.classList.contains("atcb-dropoverlay") || !o
          ? (s.style.top = window.scrollY + l.top + l.height + "px")
          : (s.style.top = window.scrollY + r.top + l.height + "px"),
        (s.style.left = l.left + (l.width - 150) / 2 + "px")));
}
...
function atcb_debounce_leading(e, t = 300) {
  let a;
  return (...n) => {
    a || e.apply(this, n),
      clearTimeout(a),
...
function atcb_throttle(e, t = 10) {
  let a,
    ...
    o = 0,
    i = (...t) => {
      (o = Date.now()), (n = null), (a = e.apply(this, t));
    };
  return (...r) => {
    var l = Date.now(),
      s = t - (l - o);
    return (
      s <= 0 || t < s
        ? (n && (clearTimeout(n), (n = null)), (o = l), (a = e.apply(this, r)))
        : (n = n || setTimeout(i, s)),
      a
    );
  };
...
function atcb_translate_hook(e, t) {
  var a = e.replace(/\s+/g, "").toLowerCase();
  return null != t.customLabels &&
    null != t.customLabels["" + a] &&
    "" != t.customLabels["" + a]
    ? atcb_rewrite_html_elements(t.customLabels["" + a])
    : atcb_translate(e, t.language);
}
function atcb_translate(e, t) {
  return i18nStrings["" + (t = t || "en")]["" + e] || e;
}
...
function atcb_init() {
  if (
    ...
    const n = document.querySelectorAll(".atcb");
    var e = [];
    if (0 < n.length) {
      var t,
        a = document.querySelectorAll(".atcb-initialized");
      for (let o = 0; o < n.length; o++)
        n[parseInt(o)].classList.contains("atcb-initialized") ||
          (0 !=
            (t = atcb_get_pro_data(
              atcb_patch_config(
                (function () {
            ...
            ((null != (t = atcb_decorate_data(t)).identifier &&
              "" != t.identifier) ||
              (t.identifier = "atcb-btn-" + (o + a.length + 1)),
            atcb_validate(t) &&
              (atcb_generate_button(n[parseInt(o)], t),
...
function atcb_destroy(e) {
  ...
  return null != atcbStates["" + e] && t
    ? (delete atcbStates["" + e],
      (t.parentElement.parentElement.classList.contains("atcb-initialized")
...
function atcb_update_state_management(e) {
  var t = [];
  for (let a = 0; a < e.options.length; a++) {
    t[e.options["" + a]] = [];
    for (let n = 1; n <= e.dates.length; n++) t[e.options["" + a]].push(0);
  }
  atcbStates[e.identifier] = t;
}
function atcb_init_log_msg() {
  atcbInitialInit ||
    (console.log("Add to Calendar Button Script initialized (version 1.18.7)"),
    console.log(
  ...
  isBrowser() &&
    ...
    document.addEventListener("keydown", (e) => {
      if (
        ...
        var t = document.activeElement,
          a = document.querySelectorAll(".atcb-list-item").length;
        if (t.classList.contains("atcb-list-item"))
          "ArrowDown" === e.key && t.dataset.optionNumber < a
            ? (e.preventDefault(), (n = parseInt(t.dataset.optionNumber) + 1))
            : "ArrowUp" === e.key &&
    ...
    window.addEventListener(
      ...
      atcb_throttle(() => {
        ...
        null !=
          (t =
            (null != (t = document.getElementById("atcb-bgoverlay")) &&
              (atcb_set_fullsize(t), atcb_manage_body_scroll()),
            document.querySelector(".atcb-active"))) &&
          null != (e = document.querySelector(".atcb-dropdown")) &&
          atcb_position_list(t, e, !1, !0);
      })
    ),
    window.addEventListener(
      "scroll",
      atcb_throttle(() => {
        var e,
          t = document.querySelector(".atcb-active");
        null != t &&
          null != (e = document.querySelector(".atcb-dropdown")) &&
...
isBrowser() &&
  ...
  (function (e, t) {
    ...
    const t = (e) => {
        const t = {};
        for (const a in e) t[e[a]] = "swal2-" + e[a];
        return t;
      },
      a = t([
        "container",
      ...
      g = () => b(a.icon),
      f = () => b(a.title),
      y = () => b(a["html-container"]),
      v = () => b(a.image),
      _ = () => b(a["progress-steps"]),
      T = () => b(a["validation-message"]),
      A = () => p(`.${a.actions} .${a.confirm}`),
      w = () => p(`.${a.actions} .${a.deny}`),
      C = () => p(`.${a.loader}`),
      k = () => p(`.${a.actions} .${a.cancel}`),
      E = () => b(a.actions),
      S = () => b(a.footer),
      L = () => b(a["timer-progress-bar"]),
      Y = () => b(a.close),
      D = () => {
        const e = Array.from(
            h().querySelectorAll(
            ...
            const a = parseInt(e.getAttribute("tabindex")),
      ...
      B = () =>
        x(document.body, a.shown) &&
        !x(document.body, a["toast-shown"]) &&
        !x(document.body, a["no-backdrop"]),
      z = () => h() && x(h(), a.toast),
      M = { previousBodyPadding: null },
      R = (e, t) => {
        if (((e.textContent = ""), t)) {
          const a = new DOMParser().parseFromString(t, "text/html");
          Array.from(a.querySelector("head").childNodes).forEach((t) => {
            e.appendChild(t);
          }),
            Array.from(a.querySelector("body").childNodes).forEach((t) => {
      ...
      F = (e, t) => {
        ...
        for (let e = 0; e < a.length; e++) {
          const n = a[e];
          if (n instanceof HTMLElement && x(n, t)) return n;
        }
      },
      Z = (e, t, a) => {
        a === `${parseInt(a)}` && (a = parseInt(a)),
          a || 0 === parseInt(a)
            ? (e.style[t] = "number" == typeof a ? `${a}px` : a)
      ...
      ne = (e, t) => {
        e.jquery ? oe(t, e) : R(t, e.toString());
      },
      oe = (e, t) => {
    ...
    function re(e, t, n) {
      V(e, n[`show${o(t)}Button`], "inline-block"),
        R(e, n[`${t}ButtonText`]),
      ...
      de = (e, t, n) => {
        if (n.inputLabel) {
          ...
          o.setAttribute("for", e.id),
            (o.className = i),
            "object" == typeof n.customClass && N(o, n.customClass.inputLabel),
            (o.innerText = n.inputLabel),
            t.insertAdjacentElement("beforebegin", o);
        }
      },
      ue = (e) => F(h(), a[e] || a.input),
      me = (e, t) => {
    ...
    (pe.text =
      ...
      pe.url =
        (e, t) => (
          me(e, t.inputValue), de(e, e, t), ce(e, t), (e.type = t.input), e
        )),
      (pe.file = (e, t) => (de(e, e, t), ce(e, t), e)),
      (pe.range = (e, t) => {
      ...
      (pe.checkbox = (e, t) => {
        const n = U(h(), "checkbox");
        (n.value = "1"),
          (n.id = a.checkbox),
          (n.checked = Boolean(t.inputValue));
        const o = e.querySelector("span");
        return R(o, t.inputPlaceholder), n;
      }),
      (pe.textarea = (e, t) => (
        me(e, t.inputValue),
        ce(e, t),
    ...
    const be = (t, n) => {
        ...
        O(o, n, "htmlContainer"),
          n.html
            ? (ae(n.html, o), q(o, "block"))
            : n.text
            ? ((o.textContent = n.text), q(o, "block"))
            : j(o),
          ((t, n) => {
            const o = h(),
              i = e.innerParams.get(t),
              r = !i || n.input !== i.input;
            le.forEach((e) => {
              const t = F(o, a[e]);
              ((e, t) => {
      ...
      he = (e, t) => {
        for (const a in n) t.icon !== a && I(e, n[a]);
        N(e, n[t.icon]), ye(e, t), ge(), O(e, t, "icon");
      },
      ge = () => {
        const e = h(),
      ...
      ye = (e, t) => {
        if (t.iconColor) {
          ...
          for (const a of [
            ...
            $(e, a, "backgroundColor", t.iconColor);
          $(e, ".swal2-success-ring", "borderColor", t.iconColor);
        }
      },
      ve = (e) => `<div class="${a["icon-content"]}">${e}</div>`,
      _e = (e, t) => {
        (e.className = `${a.popup} ${K(e) ? t.showClass.popup : ""}`),
          t.toast
            ? (N([document.documentElement, document.body], a["toast-shown"]),
              N(e, a.toast))
            : N(e, a.modal),
          O(e, t, "popup"),
          "string" == typeof t.customClass && N(e, t.customClass),
          t.icon && N(e, a[`icon-${t.icon}`]);
      },
      Te = (t, o) => {
        ((e, t) => {
          const a = m(),
              ...
              ? (q(n),
                ...
                t.progressSteps.forEach((e, o) => {
                  const i = ((e) => {
                    ...
                    return N(t, a["progress-step"]), R(t, e), t;
                  })(e);
                  if (
                    (n.appendChild(i),
                    o === t.currentProgressStep &&
                      N(i, a["active-progress-step"]),
                    o !== t.progressSteps.length - 1)
                  ) {
                    const e = ((e) => {
                      const t = document.createElement("li");
                      return (
                        N(t, a["progress-step-line"]),
          ...
          ((t, a) => {
            const o = e.innerParams.get(t),
              i = g();
            if (o && a.icon === o.icon) return fe(i, a), void he(i, a);
            if (a.icon || a.iconHtml) {
              if (a.icon && -1 === Object.keys(n).indexOf(a.icon))
                return (
                  r(
              ...
              q(i), fe(i, a), he(i, a), N(i, a.showClass.icon);
            } else j(i);
          })(t, o),
          ((e, t) => {
            const n = v();
          ...
          ((e, t) => {
            const a = f();
            V(a, t.title || t.titleText, "block"),
              t.title && ae(t.title, a),
              t.titleText && (a.innerText = t.titleText),
              O(a, t, "title");
          })(0, o),
          ((e, t) => {
            const a = Y();
            R(a, t.closeButtonHtml),
              O(a, t, "closeButton"),
              V(a, t.showCloseButton),
                    ...
                    o.buttonsStyling
                      ? (N([e, t, n], a.styled),
                        o.confirmButtonColor &&
                          ...
                          N(e, a["default-outline"])),
                        o.denyButtonColor &&
                          ((t.style.backgroundColor = o.denyButtonColor),
                          N(t, a["default-outline"])),
                        o.cancelButtonColor &&
                          ((n.style.backgroundColor = o.cancelButtonColor),
                          N(n, a["default-outline"])))
                      : I([e, t, n], a.styled);
                  })(o, i, r, n),
                  n.reverseButtons &&
                    (n.toast
          ...
          ((e, t) => {
            const a = S();
            V(a, t.footer), t.footer && ae(t.footer, a), O(a, t, "footer");
          })(0, o),
          "function" == typeof o.didRender && o.didRender(h());
      };
    function Ae() {
    ...
    const we = (e) => {
      ...
      Se = (e, t, a) => {
        ...
        if (n.length)
          return (
            (t += a) === n.length ? (t = 0) : -1 === t && (t = n.length - 1),
            n[t].focus()
          );
        h().focus();
      },
        ...
        o &&
          (a.isComposing ||
            ...
            "Enter" === a.key
              ...
              : "Tab" === a.key
              ? ze(a, o)
              : [...Le, ...Ye].includes(a.key)
              ? Me(a.key)
              : "Escape" === a.key && Re(a, o, n)));
      },
      Be = (e, t, a) => {
        if (
          s(a.allowEnterKey) &&
      ...
      Me = (e) => {
        ...
        if (
          ...
          ![t, a, n].includes(document.activeElement)
        )
          return;
        const o = Le.includes(e)
          ? "nextElementSibling"
          : "previousElementSibling";
        let i = document.activeElement;
        for (let e = 0; e < E().children.length; e++) {
          if (((i = i[o]), !i)) return;
          if (i instanceof HTMLButtonElement && K(i)) break;
        }
        i instanceof HTMLButtonElement && i.focus();
      },
      Re = (e, t, a) => {
        s(t.allowEscapeKey) && (e.preventDefault(), a(ke.esc));
      };
    var xe = {
    ...
    const Oe = () => {
      ...
      He = (e) => e.touches && e.touches.length > 1;
    function Ne(e, t, n, o) {
      z()
        ? Ve(e, o)
        : (((e) =>
    ...
    function Ie(e) {
      e = qe(e);
      const t = xe.swalPromiseResolve.get(this),
        a = Fe(this);
      this.isAwaitingPromise() ? e.isDismissed || (Ze(this), t(e)) : a && t(e);
    }
    const Fe = (t) => {
        const a = h();
        if (!a) return !1;
        const n = e.innerParams.get(t);
        if (!n || x(a, n.hideClass.popup)) return !1;
        I(a, n.showClass.popup), N(a, n.hideClass.popup);
        const o = m();
        return (
          I(o, n.showClass.backdrop),
          N(o, n.hideClass.backdrop),
          je(t, a, n),
          !0
        );
      },
      ...
      je = (e, t, a) => {
        ...
        "function" == typeof a.willClose && a.willClose(t),
          o
            ? $e(e, t, n, a.returnFocus, a.didClose)
            : Ne(e, n, a.returnFocus, a.didClose);
      },
      $e = (e, t, a, n, o) => {
        (J.swalCloseEventFinishedCallback = Ne.bind(null, e, a, n, o)),
    ...
    function Qe(e, t) {
      if (e)
        if ("radio" === e.type) {
          ...
          for (let e = 0; e < a.length; e++) a[e].disabled = t;
        } else e.disabled = t;
    }
    const Ge = {
        title: "",
      ...
      et = (e) => Object.prototype.hasOwnProperty.call(Ge, e),
      tt = (e) => -1 !== We.indexOf(e),
      at = (e) => Je[e],
      nt = (e) => {
        et(e) || i(`Unknown parameter "${e}"`);
      },
      ot = (e) => {
        Xe.includes(e) && i(`The parameter "${e}" is incompatible with toasts`);
      },
      it = (e) => {
        at(e) &&
          ((e, t) => {
            var a;
            (a = `"${e}" is deprecated and will be removed in the next major release. Please use "${t}" instead.`),
              l.includes(a) || (l.push(a), i(a));
          })(e, at(e));
      },
      rt = (t) => {
        t.isAwaitingPromise()
          ? (lt(e, t), e.awaitingPromise.set(t, !0))
          : (lt(xe, t), lt(e, t));
      },
      lt = (e, t) => {
        for (const a in e) e[a].delete(t);
      };
    var st = Object.freeze({
      ...
      disableLoading: Ae,
      getInput: function (t) {
        const a = e.innerParams.get(t || this),
          n = e.domCache.get(t || this);
        return n ? U(n.popup, a.input) : null;
      },
      close: Ie,
      ...
      rejectPromise: function (e) {
        const t = xe.swalPromiseReject.get(this);
        Ze(this), t && t(e);
      },
      ...
      showValidationMessage: function (t) {
        ...
        R(n.validationMessage, t),
          (n.validationMessage.className = a["validation-message"]),
          o.customClass &&
            o.customClass.validationMessage &&
            N(n.validationMessage, o.customClass.validationMessage),
          q(n.validationMessage);
        ...
        const o = ((e) => {
            ...
            return (
              Object.keys(e).forEach((a) => {
                tt(a) ? (t[a] = e[a]) : i(`Invalid parameter to update: ${a}`);
              }),
              t
            );
          })(t),
    ...
    const ct = (e) => {
      ...
      pt = {
        select: (e, t, n) => {
          const o = F(e, a.select),
            i = (e, t, a) => {
              const o = document.createElement("option");
              (o.value = a),
                R(o, t),
                (o.selected = ht(a, n.inputValue)),
                e.appendChild(o);
            };
          t.forEach((e) => {
            const t = e[0],
      ...
      bt = (e) => {
        ...
        return (
          "undefined" != typeof Map && e instanceof Map
            ? e.forEach((e, a) => {
                let n = e;
                "object" == typeof n && (n = bt(n)), t.push([a, n]);
              })
            : Object.keys(e).forEach((a) => {
                let n = e[a];
                "object" == typeof n && (n = bt(n)), t.push([a, n]);
      ...
      gt = (t, a) => {
        ...
        if (!n.input)
          return void r(
            `The "input" parameter is needed to be set when using returnInputValueOn${o(
              a
            )}`
          );
        const i = ((e, t) => {
          ...
          switch (t.input) {
            case "checkbox":
              return ((e) => (e.checked ? 1 : 0))(a);
            case "radio":
              return ((e) => (e.checked ? e.value : null))(a);
            case "file":
              return ((e) =>
                e.files.length
      ...
      ft = (t, a, n) => {
        ...
        t.disableInput(),
          Promise.resolve()
            .then(() => d(o.inputValidator(a, o.validationMessage)))
            .then((e) => {
              t.enableButtons(),
                t.enableInput(),
                e
      ...
      yt = (t, a) => {
        ...
        n.showLoaderOnDeny && ct(w()),
          n.preDeny
            ? (e.awaitingPromise.set(t || void 0, !0),
              Promise.resolve()
                .then(() => d(n.preDeny(a, n.validationMessage)))
                .then((e) => {
                  !1 === e
                    ? (t.hideLoading(), Ze(t))
                    : t.close({ isDenied: !0, value: void 0 === e ? a : e });
                })
                .catch((e) => _t(t || void 0, e)))
            : t.close({ isDenied: !0, value: a });
      },
      vt = (e, t) => {
        ...
        n.showLoaderOnConfirm && ct(),
          n.preConfirm
            ? (t.resetValidationMessage(),
              e.awaitingPromise.set(t || void 0, !0),
              Promise.resolve()
                .then(() => d(n.preConfirm(a, n.validationMessage)))
                .then((e) => {
                  K(T()) || !1 === e
                    ? (t.hideLoading(), Ze(t))
                    : vt(t, void 0 === e ? a : e);
        ...
        if (J.timeout)
          return (
            (() => {
              ...
              const a = (t / parseInt(window.getComputedStyle(e).width)) * 100;
              e.style.removeProperty("transition"), (e.style.width = `${a}%`);
            })(),
            J.timeout.stop()
          );
      },
      ...
      Yt = (e) => {
        for (let t = e.target; t && t !== document; t = t.parentNode)
          for (const e in Lt) {
            ...
            if (a) return void Lt[e].fire({ template: a });
          }
      };
    var Dt = Object.freeze({
      ...
      argsToParams: (e) => {
        const t = {};
        return (
          "object" != typeof e[0] || Ct(e[0])
            ? ["title", "html", "icon"].forEach((a, n) => {
                const o = e[n];
                "string" == typeof o || Ct(o)
                  ? (t[a] = o)
                  : void 0 !== o &&
                    r(
      ...
      bindClickHandler: function () {
        let e =
          arguments.length > 0 && void 0 !== arguments[0]
            ...
            : "data-swal-template";
        (Lt[e] = this),
          St || (document.body.addEventListener("click", Yt), (St = !0));
      }
    });
    class Bt {
      constructor(e, t) {
    ...
    const zt = ["swal-title", "swal-html", "swal-footer"],
      Mt = (e, t) => {
      ...
      xt = (e) => {
        ...
        const a = m();
        t.removeEventListener(ie, xt), (a.style.overflowY = "auto");
      },
      Ot = (e, t) => {
        ie && G(t)
          ? ((e.style.overflowY = "hidden"), t.addEventListener(ie, xt))
            ...
            (document.body.style.top = -1 * e + "px"),
              ...
              (() => {
                const e = navigator.userAgent,
                  ...
                  a = !!e.match(/WebKit/i);
                if (t && a && !e.match(/CriOS/i)) {
                  const e = 44;
                  h().scrollHeight > window.innerHeight - e &&
      ...
      Pt = (e, t, n) => {
        N(e, n.showClass.backdrop),
          t.style.setProperty("opacity", "0", "important"),
          q(t, "grid"),
          setTimeout(() => {
            N(t, n.showClass.popup), t.style.removeProperty("opacity");
          }, 10),
          N([document.documentElement, document.body], a.shown),
          n.heightAuto &&
            n.backdrop &&
            !n.toast &&
            N([document.documentElement, document.body], a["height-auto"]);
      };
    var Ht = {
      email: (e, t) =>
    ...
    function Nt(e) {
      !(function (e) {
        ...
        ((e) => {
          ...
          if (X()) return void r("SweetAlert2 requires document to initialize");
          const n = document.createElement("div");
          (n.className = a.container), t && N(n, a["no-transition"]), R(n, ee);
          const o =
          ...
          o.appendChild(n),
            ...
            ((e) => {
              "rtl" === window.getComputedStyle(e).direction && N(m(), a.rtl);
            })(o),
            (() => {
              const e = h(),
                t = F(e, a.input),
                n = F(e, a.file),
                o = e.querySelector(`.${a.range} input`),
                i = e.querySelector(`.${a.range} output`),
                r = F(e, a.select),
                l = e.querySelector(`.${a.checkbox} input`),
                s = F(e, a.textarea);
              (t.oninput = te),
                (n.onchange = te),
                (r.onchange = te),
    ...
    class Ft {
      constructor() {
        ...
        for (var t = arguments.length, a = new Array(t), n = 0; n < t; n++)
          a[n] = arguments[n];
        const o = Object.freeze(this.constructor.argsToParams(a));
        Object.defineProperties(this, {
          params: { value: o, writable: !1, enumerable: !0, configurable: !0 }
        });
        const i = It._main(It.params);
      ...
      _main(t) {
        ...
        ((e) => {
          ...
          for (const t in e) nt(t), e.toast && ot(t), it(t);
        })(Object.assign({}, a, t)),
          J.currentInstance && (J.currentInstance._destroy(), B() && Oe()),
        ...
        const o = jt(It);
        return Te(It, n), e.innerParams.set(It, n), Zt(It, o, n);
      }
      then(t) {
    ...
    const Zt = (t, a, n) =>
        new Promise((o, i) => {
          ...
          xe.swalPromiseResolve.set(t, o),
            xe.swalPromiseReject.set(t, i),
            (a.confirmButton.onclick = () => {
              ((t) => {
                const a = e.innerParams.get(t);
                t.disableButtons(), a.input ? gt(t, "confirm") : Tt(t, !0);
              })(t);
            }),
            (a.denyButton.onclick = () => {
              ((t) => {
                const a = e.innerParams.get(t);
                t.disableButtons(),
                  a.returnInputValueOnDeny ? gt(t, "deny") : yt(t, !1);
              })(t);
            }),
            (a.cancelButton.onclick = () => {
              ((e, t) => {
                e.disableButtons(), t(ke.cancel);
              })(t, r);
            }),
            ...
            ((t, a, n) => {
              e.innerParams.get(t).toast
                ? ((t, a, n) => {
                    a.popup.onclick = () => {
                      const a = e.innerParams.get(t);
                      (a && (At(a) || a.timer || a.input)) || n(ke.close);
                    };
                  })(t, a, n)
                : (((e) => {
                    e.popup.onmousedown = () => {
                  ...
                  ((t, a, n) => {
                    a.container.onclick = (o) => {
                      const i = e.innerParams.get(t);
                      wt
                        ? (wt = !1)
                        : o.target === a.container &&
                          s(i.allowOutsideClick) &&
                          n(ke.backdrop);
                    };
                  })(t, a, n));
            })(t, a, r),
            ((e, t, a, n) => {
              Ee(t),
                a.toast ||
                  ...
                  (t.keydownTarget = a.keydownListenerCapture ? window : h()),
      ...
      qt = (e, t) => {
        const a = ((e) => {
            ...
            return (
              ((e) => {
                ...
                Array.from(e.children).forEach((e) => {
                  ...
                  t.includes(a) || i(`Unrecognized element <${a}>`);
                });
              })(a),
              Object.assign(
                ((e) => {
                      ...
                      (e) => {
                        ...
                        (t[`${a}ButtonText`] = e.innerHTML),
                          ...
                          e.hasAttribute("color") &&
                            (t[`${a}ButtonColor`] = e.getAttribute("color")),
                ...
                ((e) => {
                  ...
                  return (
                    a &&
                      (Mt(a, ["src", "width", "height", "alt"]),
                      a.hasAttribute("src") &&
                        (t.imageUrl = a.getAttribute("src")),
                      a.hasAttribute("width") &&
                        (t.imageWidth = a.getAttribute("width")),
                      a.hasAttribute("height") &&
                        (t.imageHeight = a.getAttribute("height")),
                      a.hasAttribute("alt") &&
                        (t.imageAlt = a.getAttribute("alt"))),
                    t
                  );
                })(a),
                ((e) => {
                ...
                ((e) => {
                  ...
                  a &&
                    (Mt(a, ["type", "label", "placeholder", "value"]),
                ...
                ((e, t) => {
                  ...
                  for (const n in t) {
                    ...
                    i &&
                      (Mt(i, []),
                      (a[o.replace(/^swal-/, "")] = i.innerHTML.trim()));
                  }
                  return a;
                })(a, zt)
              )
          ...
          n = Object.assign({}, Ge, t, a, e);
        return (
          (n.showClass = Object.assign({}, Ge.showClass, n.showClass)),
          (n.hideClass = Object.assign({}, Ge.hideClass, n.hideClass)),
          n
        );
      },
      jt = (t) => {
      ...
      $t = (e, t, a) => {
        ...
        j(n),
          t.timer &&
            ...
            t.timerProgressBar &&
              (q(n),
              O(n, t, "timerProgressBar"),
              setTimeout(() => {
                e.timeout && e.timeout.running && W(t.timer);
              })));
      },
      Vt = (e, t) => {
        t.toast || (s(t.allowEnterKey) ? Kt(e, t) || Se(0, -1, 1) : Qt());
      },
      Kt = (e, t) =>
